...
public class FlightService {
    ...
    public Flight updateFlight(int flight_id, Flight flight)
    {
        if(flightDAO.getFlightById(flight_id) != null)
        {
            ...
            if(flightDAO.getFlightById(flight_id).getDeparture_city().equals(flight.getDeparture_city()) &&
            flightDAO.getFlightById(flight_id).getArrival_city().equals(flight.getArrival_city()))
